...
public class SceneTest {
    ...
    public void testDraw() {
        ...
        assertNotNull(scene.getVisualHelicopter());
        ...
        Mockito.verify(graphics, Mockito.times(5 + vmonstersSize * this.scene.getVisualMonsters().get(0).getForm().length)).setForegroundColor(Mockito.any());
